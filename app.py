...
st.set_page_config(page_title="Sistema Escolar - CCMNC by Leandro Malheiros V2.0.3 ", layout="centered")
...
@st.cache_resource
def conectar():
    uri = "mongodb+srv://lsouzamalheiros_db_user:HBpASFoJn9kRK2KG@cluster0.zogaia0.mongodb.net/"
...
def exportar_ocorrencias_para_pdf(ocorrencias, nome_arquivo):
    ...
    elementos.append(Paragraph(
        "<b>COLÉGIO CÍVICO MILITAR NILO CAIRO</b>",
        cabecalho_style
    ))
